pub mod macros {
    ...
    macro_rules! tryok {
        ($expr:expr) => {
            $crate::output::traits::Response::from_value($expr.into())
        };
    }
    pub(crate) use tryok;
    ...
    macro_rules! tryerr {
        ($expr:expr) => {
            $crate::output::traits::Response::from_error($expr.into())
        };
    }
    ...
    macro_rules! tryres {
        ($expr:expr) => {
            $crate::output::traits::Response::from_residual($expr)
        };
    }
    ...
    macro_rules! lifterr {
        ($ident:ident) => {
            <$ident::Output as $crate::output::traits::Response>::Residual
        };
        ($ident:ident :: $assoc:ident) => {
            <$ident::$assoc as $crate::output::traits::Response>::Residual
        };
    }
    ...
    macro_rules! intoerr {
        ($($tt:tt)*) => {
            $crate::output::traits::IntoErr<$crate::output::util::err![$($tt)*]>
        };
    }
